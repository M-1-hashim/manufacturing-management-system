 ...
 *
 * 1) کلاینت Prisma در زمان build به یک provider قفل می‌شود (sqlite یا mysql).
 ...
 * 2) معماری v1.0.10 (همگام‌سازی لحظه‌ای):
 ...
 * 3) حذف‌ها (delete/deleteMany) همیشه ژورنال می‌شوند تا روی هاست تکرار
