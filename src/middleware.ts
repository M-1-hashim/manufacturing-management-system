...
export async function middleware(req: NextRequest) {
  ...
  // PUT تنظیمات فقط ادمین/مدیر (GET برای همه کاربران واردشده آزاد است)
  ...
  // تغییر وضعیت (نوشتن) فقط برای غیرناظر — ناظر فقط خواندن (به‌جز مسیرهای auth مانند تغییر رمز خود)
