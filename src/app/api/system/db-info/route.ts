 ...
 * به کاربر نشان می‌دهد برنامه واقعاً به کدام دیتابیس وصل است، نسخهٔ هاست،
 * و اینکه 19 جدول سیستم کامل ساخته شده است یا نه.
 *
 * حالت‌ها:
 ...
 * در حالت خطا، کد Prisma/MySQL به تشخیص سادهٔ دری ترجمه می‌شود تا کاربر
 * بدون دانش فنی بفهمد مشکل کجاست (پورت بسته؟ پسورد غلط؟ جدول‌های ناقص؟).
 */
